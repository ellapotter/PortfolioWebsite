...
export const projects: Project[] = [
  {
    ...
    technologies: ["Flutter", "Dart", "Python", "Flask", "MySQL", "REST APIs", "Stripe", "Socket.IO", "GitHub"],
    featured: true,
  },
  {
    id: "election-system",
    ...
    technologies: ["Python", "Flask", "MySQL", "Jinja", "HTML/CSS", "JavaScript", "Flask-Login", "bcrypt", "pytest"],
    featured: false,
  ...
  },
  {
    ...
    technologies: ["Python", "Flask", "MySQL", "SQL", "Jinja", "HTML/CSS", "JavaScript"],
    featured: false,
  },
  {
    id: "giftwise",
