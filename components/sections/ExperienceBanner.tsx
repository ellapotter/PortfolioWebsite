  ...
  return (
    <AnimatedSection id="experience" className={`bg-pink-50 ${sectionPaddingCompact}`}>
      <div className={sectionContainer}>
        <div className="flex flex-col gap-4 rounded-2xl border border-pink-200 bg-white p-6 shadow-md shadow-pink-100 sm:flex-row sm:items-center sm:justify-between lg:rounded-3xl lg:gap-8 lg:p-8">
